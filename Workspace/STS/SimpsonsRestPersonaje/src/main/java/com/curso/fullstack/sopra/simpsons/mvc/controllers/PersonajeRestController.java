...
public class PersonajeRestController {
	...
	public ResponseEntity<Personaje> get(@PathVariable String id) {
		...
		Personaje Ling = new Personaje("Ling","Ling Jaja");
		Personaje Lisa = new Personaje("Ling","Ling Jaja");
		Personaje Ling = new Personaje("Ling","Ling Jaja");
		
		Set<Personaje> cousins = new HashSet<Personaje>();
		cousins.add(new Personaje());
		Set<Personaje> brothers = new HashSet<Personaje>();
		brothers.add("Lisa");
		brothers.add("Maggie");
		...
		Personaje Homer = new Personaje("Homer", "Homer Simpson", 38, , , brothers, cousins);
		Personaje Marge = new Personaje("Marge", "Marge Crazy", 38, , , brothers, cousins);
